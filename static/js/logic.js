...
// Create an overlaylayer that holds earthquare data.
let overlayMaps = {
...
d3.json(url).then(function(data) {
    ...
    L.geoJson(data, {
        // We set the style for each circleMarker using our myStyle function.
        style: myStyle,
    ...
    // Creating a legend for the GeoJSON Layer
    ...
    var div = L.DomUtil.create('div', 'info legend'),
        ...
        colors = ["#98ee00", "#d4ee00", "#0000FF", "#ee9c00", "#ea822c", "#ea2c2c"];
    ...
    // We can now add the earthquakes layer to our map
