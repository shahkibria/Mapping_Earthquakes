...
// Add Second GeoJSON data [THIS DATA IS MADE UP].
let fosterCity =
{"type":"FeatureCollection","features":[{
    "type":"Feature",
    "properties":{
        ...
        "geometry":{
            "type":"Point",
            "coordinates":[-122.2732120005077,37.55983059791158]}}
]};
...
var streets = L.tileLayer('https://api.mapbox.com/styles/v1/mapbox/navigation-night-v1/tiles/{z}/{x}/{y}?access_token={accessToken}', {
